...
# Toute les fonctionnalités de notre jeu
class Game:
    ...
    def __init__(self):
        ...
        self.background = pygame.image.load('assets_samourai/bg.png') # Nos fonds d'écran des différentes vagues
        self.background2 = pygame.image.load('assets_samourai/maudit.jpg')
        self.background3 = pygame.image.load('assets_samourai/bg.jpg')
        self.game_over_sounds = pygame.mixer.Sound("assets_samourai/sounds/game_over.ogg")
        self.comet_sounds = pygame.mixer.Sound("assets_samourai/sounds/meteorite.ogg")
        self.projectile_sounds = pygame.mixer.Sound("assets_samourai/sounds/tir.ogg")
        self.running_samourai , self.moove_right, self.moove_left = True, True, True    # Grâce au tuple

    def moove_right_life_bar(self):
        self.life_bar.rect_form[0] += self.player.vitesse
    ...
    def reset_game(self):
        ...
        self.life_bar.rect_form = pygame.Rect(395, 440, 100, 5)
        self.score = 0
        self.comet_storm = False
        self.monster2.colosse = True
        self.comet.comet_test = 0
    ...
    def player_orientation(self):
        ...
        if self.player.p_return == False:
            ...
            player_image_return = pygame.image.load('assets_samourai/samurai.png')

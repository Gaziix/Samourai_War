...
class Goblin(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.image_goblin_1 = pygame.image.load('assets_samourai/goblin.png')
        self.image_goblin_1 = pygame.transform.scale(self.image_goblin_1, (95, 128))
        self.rect_golbin_1 = self.image_goblin_1.get_rect()
        self.rect_golbin_1.x = 1080
        self.image_goblin_2 = pygame.image.load('assets_samourai/goblin_return.png')
        self.image_goblin_2 = pygame.transform.scale(self.image_goblin_2, (95, 128))
    ...
    def defend_monster_1(self):
        ...
        if self.health == 0:
            ...
            if self.game.player.health >= 100:
                ...
                self.game.life_bar.rect_form[2] = 100
            elif self.game.player.health <= 99:
                self.game.player.health += 20
                self.game.life_bar.rect_form[2] += 20
...
class Colosse(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.image_colosse_1 = pygame.image.load('assets_samourai/colosse.png')
...
class Ghost(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.image_ghost_1 = pygame.image.load('assets_samourai/fantome.png')
        ...
        self.image_ghost_2 = pygame.image.load('assets_samourai/fantome_return.png')
...
class Mummy(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.image_mummy_1 = pygame.image.load('assets_samourai/mummy.png')
        self.rect_mummy_1 = self.image_mummy_1.get_rect()
        self.rect_mummy_1.x = 1080

        self.image_mummy_2 = pygame.image.load('assets_samourai/mummy_return.png')
